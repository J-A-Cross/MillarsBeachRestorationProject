...
<div className="bg-[url('https://upload.wikimedia.org/wikipedia/commons/c/c8/Altja_j%C3%B5gi_Lahemaal.jpg')] bg-cover bg-center bg-no-repeat bg-fixed">
  ...
  <div className="mx-15 my-10 flex h-auto flex-row rounded-2xl bg-blue-800/80 text-white">
    ...
    <div>
      ...
      <p className="mx-7 mt-5 mb-8 pr-2">I think the nature of the first half of the semester means that there is not excessive amounts of practical activity, but that it is ok as there is a proper time and places for different learning types during study, and the flow during this course is logical and we as students can see the direction we are going (Which is not always thethat there is not excessive amounts of practical activity, but that it is ok as there is a proper time and places for different learning types during study, and the flow during this course is logical and we as students can see the direction we are going (Which is not always the case with other classNamees). case with other classNamees).</p>
    </div>
  </div>
  ...
  <div className="mx-15 my-10 flex h-auto flex-row rounded-2xl bg-blue-800/80 text-white">
    ...
    <div>
      ...
      <p className="mx-7 mt-5 mb-8 pr-2">I think the nature of the first half of the semester means that there is not excessive amounts of practical activity, but that it is ok as there is a proper time and places for different learning types during study, and the flow during this course is logical and we as students can see the direction we are going (Which is not always the case with other classNamees).that there is not excessive amounts of practical activity, but that it is ok as there is a proper time and places for different learning types during study, and the flow during this course is logical and we as students can see the direction we are going (Which is not always the case with other classNamees).</p>
    </div>
  </div>
  </div>
</div>
